...
const en = {
  ...
  'actions.exportLog': 'Download Log',
  'log.shared': 'Log shared.',
  'log.saved': 'Log saved to your files.',
  'log.copied': 'Log copied to the clipboard.',
  'log.failed': 'Could not export the log.',
...
const zhCN = {
  ...
  'actions.exportLog': '下载日志',
  'log.shared': '日志已分享。',
  'log.saved': '日志已保存到“文件”。',
  'log.copied': '日志已复制到剪贴板。',
  'log.failed': '无法导出日志。',
  'keyboard.label': '钢琴键盘',
...
const zhTW = {
  ...
  'actions.exportLog': '下載記錄檔',
  'log.shared': '記錄檔已分享。',
  'log.saved': '記錄檔已儲存至「檔案」。',
  'log.copied': '記錄檔已複製到剪貼簿。',
  'log.failed': '無法匯出記錄檔。',
  'keyboard.label': '鋼琴鍵盤',
  'keyboard.octave': '第 {octave} 八度',
